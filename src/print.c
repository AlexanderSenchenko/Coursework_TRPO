...
{
	printf("Меню\n");
	printf("1) Найти минимальное расстояние между городами\n");
	printf("2) Найти максимальное расстояние между городами\n");
	printf("3) Найти количество различных путей между городами\n");
